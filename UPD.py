...
const GROQ_KEY     = process.env.GROQ_KEY     || 'GROQ_KEY'
const CEREBRAS_KEY = process.env.CEREBRAS_KEY || 'CEREBRAS_KEY'
const GEMINI_KEY   = process.env.GEMINI_KEY   || ''
const MISTRAL_KEY  = process.env.MISTRAL_KEY  || 'MISTRAL_KEY'
const HF_TOKEN     = process.env.HF_TOKEN     || 'HF_TOKEN'
